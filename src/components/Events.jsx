...
const Events = () => {
  return (
    <div
      id="event"
      className="flex flex-col justify-center items-center gap-4 pt-16 px-10 mb-16 xl:px-[10rem]"
    >
      ...
      <div className="w-full flex flex-col md:flex-row justify-around gap-6 text-white mb-8">
        <div
          className="h-[30rem] xl:h-[35rem] md:w-1/3 bg-cover rounded-2xl flex items-end p-5 drop-shadow-lg transform transition-transform hover:scale-105 duration-500 ease-in-out cursor-pointer"
