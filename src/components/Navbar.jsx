  ...
  return (
    <nav
      className={`w-full fixed px-5 lg:px-8 xl:px-[8%] flex items-center justify-between z-50 ${
        isScroll
          ? "bg-white backdrop-blur-lg shadow-md transition-all duration-500"
    ...
    >
      ...
      <ul className="container hidden lg:flex justify-center gap-6">
        <li>
          <a
            href="#home"
            className="hover:text-orange hover:-translate-y-1 duration-500 ease-in-out inline-block font-semibold"
          >
            Home 🏠
          </a>
        </li>
      ...
      <div className="w-auto lg:w-[21rem] flex items-center justify-between gap-3 px-2">
        <a
          ...
          target="_blank"
          className="hover:-translate-y-1 duration-500 ease-in-out hover:text-orange font-semibold"
        >
          Follow Us
        </a>
        <a href="https://www.instagram.com/baruch_ucla/" target="_blank">
          <Image
            ...
            width={25}
            height={25}
            className="w-6 hover:-translate-y-1 duration-500 ease-in-out"
            alt=""
          />
        </a>
        <a
      ...
      <ul
        ref={sideMenuRef}
        className="flex lg:hidden flex-col gap-6 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-white transition duration-500"
      >
        ...
        <li>
          <a
            href="#home"
            onClick={closeMenu}
            className="border-b-2 border-orange pb-2 hover:text-orange duration-500 ease-in-out"
          >
            Home 🏠
          </a>
        </li>
